...
VPS приобретён у хостера telecombg.ru  

Параметры вирутального сервера:  
**ОС:** Debian 11.2  
**CPU:** 6 cores  
**RAM:** 8Gb  
**SSD:** 50Gb  

На чистую операционную систему было мною самостоятельно установлено виртуальное окружение.  
По протоколу SFTP на сервер скопирован код бота и запущен с помощью скрипта.
